import { a as html, o as lazyBuildComponent, s as normalizeLabels, t as creatQueryInput } from "./common-CExKURVS.js";
import { n as config, t as createResultsPanel } from "./results-panel-C-8PM_EN.js";
...
var createSearchTabs = (inputConfig, tabsConfig, resultsRenderers, debug) => {
    ...
    ${creatQueryInput(inputConfig).element} ${createTabs(tabsConfig, resultsRenderers)}
  </div>`;
};
//#endregion
export { createSearchTabs };

//# sourceMappingURL=streamx-search-tabs.js.map